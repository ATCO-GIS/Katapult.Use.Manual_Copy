...
### [Photos Overview and Classification](#photos-overview-and-classification)
...
### [Annotations, Tracing, & Hardware Details](#annotations-tracing--hardware-details-manual)
...
- [Marker + Trace More Options](#marker--trace-more-options)
- [Power Space](#power-space)
- [Communication Space](#communication-space)
- [Copying + Pasting Markers](#copying--pasting-markers)
- [Tracing Cables](#tracing-cables)
- [Extraction Loop](#extraction-loop)
- [Photo Warnings](#photo-warnings)
...
- [Identification Placement of Attachments](#identification-placement-of-attachments-on-a-pole)
- [Cable Identification](#electric-fiber-optic-telephone-cooper-and-coaxial-cable-identification)
...
- [Mid-Span Tap](#mid-span-tap-attachmentcrossover)
- [Underground Facilities](#common-underground-facility-markers-and-equipment)
- [Placement](#placement)
- [Right of Way](#right-of-way)
- [Standard Ground Clearance](#standard-ground-clearance)

### [Office Power Tools](#office-power-tools-manual)
...
![buttoncircle](img/buttoncircle.png)
